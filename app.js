...
const galleryTop = document.querySelector('.gallery-header');
const sliderBtn = document.getElementById('create-slider');
const sliderArea = document.getElementById('sliders');
let sliders = [];
// api key
...
const createSlider = () => {
  ...
  sliderArea.appendChild(prevNext)
